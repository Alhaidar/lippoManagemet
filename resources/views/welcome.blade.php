    ...
    <div id="search">
        <div class="container-fluid">
            <div class="row justify-content-center py-4">
                <h2 class="text-center"><strong>Cari Ruko</strong></h2>
            </div>
    ...
    <div id="content">
       <div class="container">
        <div class="row justify-content-center py-5">
            <h1><strong>Ruko Tersedia</strong></h1>
            <hr>
        </div>
        <div class="row">
            <div class="col-md-9">
                   ...
                   <div class="row">
                        ...
                        @empty
                            <h2 class="m-auto py-2 text-white bg-dark p-3">TIdak ada Ruko Tersedia saat ini</h2>
                        @endforelse
                   </div>

                   <div class="panel-heading my-4" style="display:flex; justify-content:center;align-items:center;">
                       <a href="{{ route('house.all') }}" class="btn btn-dark">Lihat Semua Ruko</a>
                    </div>
