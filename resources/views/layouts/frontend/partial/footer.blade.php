    ...
    <div class="container">
        <div class="row">
          ...
          <div class="col-md-4">
            ...
            <p> <i class="fas fa-map-marker-alt"></i> Lippo Management</p>
            <p><i class="fas fa-phone"></i> 08211234567</p>
        ...
        <p class="text-center pb-2 mb-0"> &copy;Lippo Managenet Website<b></b></p>
      </div>
    </section>
</footer>
