            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="role_id" class="form-control" @error('role_id') is-invalid @enderror" id="role_id" value="{{ old('role_id') }}" required autocomplete="role_id" autofocus>
                                    ...
                                    <option value="3" {{ old('role_id') == 3 ? 'selected' : ''  }} >Penyewa</option>
                                </select>
                        ...
                        <div class="form-group row">
                            <label for="nid" class="col-md-4 col-form-label text-md-right">{{ __('Nik') }}</label>
      ...
      <div class="col-md-6 col-lg-6  col-sm-8 col-xs-8">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="input-group mb-3">
                <input type="text" class="form-control" placeholder="Nik " name="nid" value="{{ old('nid') }}">
            </div>
